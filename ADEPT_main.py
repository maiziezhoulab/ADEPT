...
if __name__ == '__main__':
    ...
    parser.add_argument('--filter_nzr', type=float, default=0.14, help='suggested nzr for filtering')
    parser.add_argument('--filter_num', type=int, default=None, help='suggested nzr for filtering')
    parser.add_argument('--de_nzr_min', type=float, default=0.299, help='suggested min nzr after de selection')
    parser.add_argument('--de_nzr_max', type=float, default=0.399, help='suggested max nzr after de selection')
