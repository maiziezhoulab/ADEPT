...
for setting_combi in setting_combinations:
    ...
    args.input_data = setting_combi[1]
    ...
    for iter_ in range(iters):
        ...
        ari_ini, ARI, de_list, adata_out = GAAE.train_STA_use_DE(imputed_ad, n_epochs=1000, num_cluster=args.cluster_num, device_id=args.use_gpu_id)
